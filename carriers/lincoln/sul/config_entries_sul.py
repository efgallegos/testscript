"""Survivorship Universal Life Configuration Dictionaries"""
...
plans = {
        'SUL_LifeGuarantee': {'full_name': 'Lincoln LifeGuarantee SUL',
                              'file_name': 'SUL_LifeGuarantee'}
        }

# Product configuration dictionary

sul_config = {
        'name': 'Survivorship Universal Life',
        'states': states,
        'plans': plans,
